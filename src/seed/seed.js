    ...
    const sampleProducts = [
      {
        ...
        price_cents: 6999,
        image_url: 'https://images.unsplash.com/photo-1542293787938-c9e299b88054',
        stock_qty: 25,
      },
      {
        name: 'Street Sneak Classic',
        description: 'Timeless low-top sneakers with durable canvas and rubber sole.',
        price_cents: 4999,
        image_url: 'https://images.unsplash.com/photo-1514986888952-8cd320577b68',
        stock_qty: 40,
      },
      {
        name: 'Trail Master GTX',
        description: 'Waterproof trail shoes with aggressive grip and protective toe cap.',
        price_cents: 8999,
      ...
      {
        name: 'Court Ace 2.0',
        description: 'All-court tennis shoes offering stability and comfort.',
        price_cents: 7999,
